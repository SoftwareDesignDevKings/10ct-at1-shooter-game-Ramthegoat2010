...
import pygame
import app
from bullet import Bullet  # Contains global settings like WIDTH, HEIGHT, PLAYER_SPEED, etc.
...
class Player:
    ...
    def update(self):
        self.shoot_timer += 1  # Update the shoot timer
    ...
    def shoot_toward_position(self, tx, ty):
        if self.shoot_timer < self.shoot_cooldown or self.bullets_left <= 0:
            return
